      ...
      <div className="lg:col-span-7 space-y-6">
        ...
        <div className="bg-[#0a0a0f] rounded-2xl border border-white/[0.06] p-6 space-y-4">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-slate-200/80 bg-gradient-to-b from-[#f0f4ff] via-white to-[#fafafa] p-6 grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch shadow-inner min-h-[300px]">
            ...
            {/* Left side: Hero Illustration Mockup (Stretched vertically to cover boundaries) */}
            <div className="md:col-span-5 flex flex-col items-center justify-center relative h-[260px]">
              ...
              <div className="absolute -top-6 -bottom-6 left-1/2 -translate-x-1/2 h-[calc(100%+3rem)] w-auto pointer-events-none z-0 flex items-center justify-center overflow-visible">
                <img
                  src={formData.heroImageUrl || heroBankImg}
                  alt="Hero Illustration preview"
                  className="h-full w-auto object-contain filter drop-shadow(0 8px 24px rgba(16,55,131,0.06))"
                  style={{
