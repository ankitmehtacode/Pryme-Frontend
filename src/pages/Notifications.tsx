        ...
        <main className="flex-1 pt-32 pb-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="flex items-center justify-between mb-10">
              <h1 className="text-3xl font-semibold text-slate-900 dark:text-white flex items-center gap-3 tracking-tight">
            ...
            <div className="space-y-4">
              {[
                { icon: ShieldCheck, title: "Identity Verified", text: "Your PAN card and Aadhaar have been successfully cross-verified with NSDL.", time: "2 hours ago", color: "text-emerald-500", bg: "bg-emerald-500/10" },
                ...
                <div key={i} className="p-6 rounded-[2rem] bg-white dark:bg-[#050505] border border-slate-200 dark:border-white/10 flex gap-6 items-start transition-all hover:bg-slate-50 dark:hover:bg-white/5 cursor-pointer">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <h3 className="font-semibold text-slate-900 dark:text-white leading-tight uppercase tracking-tight text-sm">{note.title}</h3>
