            ...
            {!showComparison ? (
              ...
              >
                <div className="container mx-auto px-4 max-w-4xl">
                  ...
                  <div className="sticky top-20 z-50 mb-8 space-y-4">
                    <div className="bg-card/90 dark:bg-[#111]/90 backdrop-blur-2xl border border-border/60 dark:border-white/5 p-4 md:p-6 rounded-[2rem] shadow-2xl transition-all duration-300">
                    ...
                    <AnimatePresence>
                      {applicationData && applicationData.cibilScore < 750 && (
                        <motion.div
                          ...
                          className="bg-amber-50/90 dark:bg-amber-950/40 backdrop-blur-2xl border border-amber-200 dark:border-amber-900/50 rounded-[2rem] p-4 shadow-xl overflow-hidden"
                        >
                          <CibilTips />
                        </motion.div>
                      )}
                  ...
                  {/* Singular Form Engine */}
                  <div
                    className="w-full relative z-10 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]"
