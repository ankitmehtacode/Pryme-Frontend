...
const OffersRewards = ({ offers = defaultOffers }: { offers?: Offer[] }) => {
  ...
  const getOfferStyling = (type: Offer["type"]) => {
    switch (type) {
      case "discount": return "text-blue-400 bg-blue-500/10 border-blue-500/20 shadow-[0_0_15px_rgba(52,211,153,0.1)] group-hover:shadow-[0_0_25px_rgba(52,211,153,0.2)]";
