...
export const HeroBadges = () => {
  return (
    <motion.div
      ...
      className="hidden md:flex flex-wrap items-start gap-3 sm:gap-4 mb-2 lg:mb-2"
    >
      {trustBadges.map((badge, i) => (
        <div key={i} className="flex flex-col items-center gap-1.5 lg:gap-1 text-center min-w-[60px]">
          <div className="w-9 h-9 lg:w-8 lg:h-8 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center">
