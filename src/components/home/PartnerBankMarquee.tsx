...
export const banks = [
  { name: "Axis Bank", logo: axisLogo + "?v=4" },
  { name: "IDBI Bank", logo: idbiLogo + "?v=4" },
  { name: "HDFC Bank", logo: hdfcLogo + "?v=4" },
  { name: "Union Bank", logo: unionLogo + "?v=4" },
  { name: "State Bank of India", logo: sbiLogo + "?v=4" },
  { name: "Bank of Baroda", logo: bobLogo + "?v=4" },
  { name: "Standard Chartered", logo: scLogo + "?v=4" },
  { name: "IndusInd Bank", logo: indusindLogo + "?v=4" },
  { name: "RBL Bank", logo: rblLogo + "?v=4" },
  { name: "ICICI Bank", logo: iciciLogo + "?v=4" },
  { name: "Kotak Mahindra", logo: kotakLogo + "?v=4" },
  { name: "Yes Bank", logo: yesLogo + "?v=4" },
  { name: "Punjab National Bank", logo: pnbLogo + "?v=4" },
  { name: "Tata Capital", logo: tataLogo + "?v=4" },
  { name: "Bajaj Finserv", logo: bajajLogo + "?v=4" },
  { name: "L&T Finance", logo: ltLogo + "?v=4" },
  { name: "Bandhan Bank", logo: bandhanLogo + "?v=4" },
  { name: "Aditya Birla Finance", logo: abflLogo + "?v=4" },
];
