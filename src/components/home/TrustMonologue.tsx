    ...
    <Tooltip>
      <TooltipTrigger asChild>
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#103783]/0 via-[#103783]/0 to-[#103783]/0 group-hover:from-[#103783]/20 group-hover:via-transparent group-hover:to-[#103783]/5 rounded-2xl transition-all duration-500 pointer-events-none" />
  ...
  return (
    <section className="py-20 md:py-28 relative bg-[#030303] overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#103783] blur-[150px] rounded-full pointer-events-none"
      />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 text-[#103783] text-xs font-semibold uppercase tracking-widest mb-6">
